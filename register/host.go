...
func registerGetHost(s *server.MCPServer) {
	s.AddTool(
		mcp.NewTool("exact_hostname_to_hostid",
			...
			mcp.WithArray("hostnames", mcp.Required(), mcp.WithStringItems(), mcp.Description("主机名称字符串数组")),
	...
	s.AddTool(
		mcp.NewTool("get_groups_by_hostname",
			...
			mcp.WithArray("selectHostGroups", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("groupid", "name", "flags", "uuid", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_graphs_by_hostname",
			...
			mcp.WithArray("selectGraphs", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("graphid", "name", "height", "width", "graphtype", "flags", "show_legend", "show_3d", "yaxismax", "yaxismin", "ymax_type", "ymin_type", "templateid", "uuid", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_templates_by_hostname",
			...
			mcp.WithArray("selectParentTemplates", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("templateid", "name", "host", "description", "vendor_version", "vendor_name", "uuid", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_items_by_hostname",
			...
			mcp.WithArray("selectItems", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("itemid", "delay", "hostid", "interfaceid", "key_", "name", "name_resolved", "type", "url",
					...
					"timeout", "trapper_hosts", "trends", "units", "username", "uuid", "valuemapid", "verify_host", "verify_peer", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_macros_by_hostname",
			...
			mcp.WithArray("selectMacros", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("hostmacroid", "hostid", "macro", "value", "type", "description", "automatic", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_tags_by_hostname",
			...
			mcp.WithArray("selectTags", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("tag", "value", "automatic", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_triggers_by_hostname",
			...
			mcp.WithArray("selectTriggers", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("triggerid", "description", "expression", "event_name", "opdata",
					...
					"correlation_tag", "manual_close", "uuid", "extend")),
	...
	s.AddTool(
		mcp.NewTool("get_dashboards_by_hostname",
			...
			mcp.WithArray("selectDashboards", mcp.Required(),
				mcp.WithStringItems(mcp.Enum("dashboardid", "name", "templateid", "display_period", "auto_start", "uuid", "extend")),
...
func registerUpdateHost(s *server.MCPServer) {
	s.AddTool(
		mcp.NewTool("update_host",
			mcp.WithDescription("更新主机"),
			mcp.WithString("instance", mcp.Required(), mcp.Description("Zabbix 实例名称")),
			mcp.WithString("hostid", mcp.Required(), mcp.Description("主机ID")),
			mcp.WithString("host", mcp.Description("主机技术名,host 字段")),
			mcp.WithString("name", mcp.Description("主机可见名称")),
			mcp.WithArray("groups", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"groupid": map[string]any{"type": "string"}}}), mcp.Description("主机组id列表, 示例: `[{ 'groupid': '12345' },{ 'groupid': '67890' }]`")),
			mcp.WithArray("interfaces", mcp.Items(map[string]any{"type": "object"}), mcp.Description("接口列表")),
			mcp.WithArray("templates", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"templateid": map[string]any{"type": "string"}}}), mcp.Description("模板ID列表, 示例: `[{ 'templateid': '12345' },{ 'templateid': '67890' }]`")),
			mcp.WithArray("tags", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"tag": map[string]any{"type": "string"}, "value": map[string]any{"type": "string"}}}), mcp.Description("主机标签数组, 示例: `[{ 'tag': 'tagname', 'value': 'tagvalue' },{ 'tag': 'tagname', 'value': 'tagvalue' }]`")),
			mcp.WithArray("macros", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"macro": map[string]any{"type": "string"}, "value": map[string]any{"type": "string"}, "description": map[string]any{"type": "string"}}}), mcp.Description("用户宏数组, 示例: `[{ 'macro': 'macroname', 'value': 'macrovalue', 'description': 'macrodescription' },{ 'macro': 'macroname', 'value': 'macrovalue', 'description': 'macrodescription' }]`")),
			mcp.WithString("options", mcp.Required(), mcp.Description("更新选项: templates groups tags macros interfaces需要与响应参数保持一致")),
		),
		handler.UpdateHostHandler,
	)
	s.AddTool(
		mcp.NewTool("clear_host_templates",
			mcp.WithDescription("清除主机关联的所有模板"),
			mcp.WithString("instance", mcp.Required(), mcp.Description("Zabbix 实例名称")),
			mcp.WithString("hostid", mcp.Required(), mcp.Description("主机ID")),
			mcp.WithArray("templates", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"templateid": map[string]any{"type": "string"}}}), mcp.Description("模板ID列表, 示例: `[{ 'templateid': '12345' },{ 'templateid': '67890' }]`")),
			mcp.WithString("options", mcp.Required(), mcp.Description("clear"), mcp.DefaultString("clear")),
		),
		handler.UpdateHostHandler,
	)
}
...
func registerHost(s *server.MCPServer) {
	s.AddTool(
		mcp.NewTool("create_host",
			...
			mcp.WithArray("groups", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"groupid": map[string]any{"type": "string"}}}), mcp.Required(), mcp.Description("主机组id列表, 示例: `[{ 'groupid': '12345' },{ 'groupid': '67890' }]`")),
			mcp.WithArray("interfaces", mcp.Items(map[string]any{"type": "object"}), mcp.Required(), mcp.Description("接口列表")),
			mcp.WithArray("templates", mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"templateid": map[string]any{"type": "string"}}}), mcp.Required(), mcp.Description("模板ID列表, 示例: `[{ 'templateid': '12345' },{ 'templateid': '67890' }]`")),
			mcp.WithArray("tags", mcp.Required(), mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"tag": map[string]any{"type": "string"}, "value": map[string]any{"type": "string"}}}), mcp.Description("主机标签数组, 示例: `[{ 'tag': 'tagname', 'value': 'tagvalue' },{ 'tag': 'tagname', 'value': 'tagvalue' }]`")),
			mcp.WithArray("macros", mcp.Required(), mcp.Items(map[string]any{"type": "object", "properties": map[string]any{"macro": map[string]any{"type": "string"}, "value": map[string]any{"type": "string"}, "description": map[string]any{"type": "string"}}}), mcp.Description("用户宏数组, 示例: `[{ 'macro': 'macroname', 'value': 'macrovalue', 'description': 'macrodescription' },{ 'macro': 'macroname', 'value': 'macrovalue', 'description': 'macrodescription' }]`")),
	...
	s.AddTool(
		mcp.NewTool("delete_host",
			...
			mcp.WithString("instance", mcp.Required(), mcp.Description("Zabbix 实例名称")),
			mcp.WithArray("hostids", mcp.WithStringItems(), mcp.Required(), mcp.Description("主机ID数组")),
		),
